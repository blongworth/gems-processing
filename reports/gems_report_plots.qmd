...
A record of the argon-normalized oxygen signal for the duration of the deployment.
...
Fitted RGA Oxygen data shows a reasonable match
to the SeapHOx optode data for the codeployment period.
...
Fluxes for the duration of the deployment are aggregated by hour of day.
Hour is adjusted to the mean solar noon for the deployment.

#### Concentration and gradient

Mean oxygen concentration across both inlets.
...
Plots below are Naushon eelgrass quadrat data plotted by year. Eelgrass, algae and epiphytes were sampled from 3-5 20 cm² quadrats. Point error bars are SD of quadrats for mass and count, SD of all blade lengths for length. Fit line is a loess fit through all data.
